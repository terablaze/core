...
use Closure;
use Terablaze\Bus\Events\BatchDispatched;
use Terablaze\Container\ContainerInterface;
use Terablaze\EventDispatcher\Dispatcher as EventDispatcher;
...
class PendingBatch
{
     ...
     * @return void
     */
    public function __construct(ContainerInterface $container, CollectionInterface $jobs)
    {
    ...
    {
        $jobs = is_iterable($jobs) ? $jobs : ArrayMethods::wrap($jobs);
    ...
    {
        return ArrayMethods::get($this->options, 'allowFailures', false) === true;
    }
    ...
    {
        $repository = $this->container->make(BatchRepositoryInterface::class);
    ...
    public function dispatchAfterResponse()
    {
        ...
        if ($batch) {
            Helpers::kernel()->terminating(function () use ($batch) {
