...
class Dispatcher implements QueueingDispatcherInterface
{
    ...
    {
        return $this->container->make(BatchRepositoryInterface::class)->find($batchId);
    }

    /**
     * Create a new batch of queueable jobs.
     *
     * @param  CollectionInterface|array|mixed  $jobs
     * @return \Terablaze\Bus\PendingBatch
     */
    public function batch($jobs)
    {
        return new PendingBatch($this->container, ArrayCollection::wrap($jobs));
    }
    ...
    {
        Helpers::kernel()->terminating(function () use ($command, $handler) {
