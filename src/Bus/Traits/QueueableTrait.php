...
trait QueueableTrait
{
    ...
    {
        $this->middleware = ArrayMethods::wrap($middleware);
    ...
    {
        $this->chained = ArrayMethods::prepend($this->chained, $this->serializeJob($job));
    ...
    public function dispatchNextJobInChain()
    {
        if (! empty($this->chained)) {
            Helpers::dispatch(tap(unserialize(array_shift($this->chained)), function ($next) {
