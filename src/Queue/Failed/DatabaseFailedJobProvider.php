...
class DatabaseFailedJobProvider implements FailedJobProviderInterface, PrunableFailedJobProvider
{
    ...
    public function log($connection, $queue, $payload, $exception)
    {
        ...
        return $this->getTable()->saveGetId(compact(
    ...
    {
        return $this->connection->query()->delete($this->table)->where('id = :id')->setParameter('id', $id)->execute() > 0;
    }
    ...
    {
        $query = $this->connection->query()->delete($this->table)->where('failed_at < :before')
