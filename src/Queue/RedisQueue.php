...
use Terablaze\Queue\Jobs\RedisJob;
use Terablaze\Redis\RedisManager;
use Terablaze\Support\StringMethods;

class RedisQueue extends Queue implements QueueInterface, ClearableQueueInterface
{
    /**
     ...
     *
     * @param  string  $queue
     * @param  \Terablaze\Queue\Jobs\RedisJob  $job
     * @return void
     */
    ...
    {
        return StringMethods::random(32);
    }
