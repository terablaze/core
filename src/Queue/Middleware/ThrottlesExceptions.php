...
use Terablaze\Cache\RateLimiter;
...
class ThrottlesExceptions
{
     ...
     * @var string
     */
    protected $prefix = 'terablaze_throttles_exceptions:';
    ...
    {
        $this->limiter = Container::getContainer()->make(RateLimiter::class);
    ...
    /**
     * Specify the number of minutes a job should be delayed when
     * it is released (before it has reached its max exceptions).
     *
     * @param  int  $backoff
     * @return $this
     */
