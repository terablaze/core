...
class MessageSelector
{
     ...
     * @return mixed
     */
    private function extract(array $segments, int $number)
    {
    ...
    private function extractFromString(string $part, int $number)
    {
        ...
        if (StringMethods::contains($condition, ',')) {
     ...
     * @return array
     */
    private function stripConditions($segments): array
    {
        return (new ArrayCollection($segments))->map(function ($part) {
