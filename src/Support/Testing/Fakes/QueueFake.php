...
class QueueFake extends QueueManager implements QueueInterface
{
    ...
    public function __construct($app, $jobsToFake = [], $queue = null)
    {
        ...
        $this->jobsToFake = ArrayCollection::wrap($jobsToFake);
        $this->jobsToBeQueued = ArrayCollection::make();
        $this->queue = $queue;
    }
    ...
    {
        $this->jobsToBeQueued = ArrayCollection::wrap($jobsToBeQueued)->merge($this->jobsToBeQueued);
    ...
    public function pushed($job, $callback = null)
    {
        ...
        return (new ArrayCollection($this->jobs[$job]))->filter(
    ...
    {
        return (new ArrayCollection($this->jobs))->flatten(1)->filter(
