...
class MessageBag implements Jsonable, JsonSerializable, MessageBagContract, MessageProvider
{
    ...
    public function first($key = null, $format = null)
    {
        ...
        $firstMessage = ArrayMethods::first($messages, null, '');

        return is_array($firstMessage) ? ArrayMethods::first($firstMessage) : $firstMessage;
    }
    ...
    protected function getMessagesForWildcardKey($key, $format)
    {
        return (new ArrayCollection($this->messages))
                ->filter(function ($messages, $messageKey) use ($key) {
                    return StringMethods::is($key, $messageKey);
                })
    ...
    {
        return (new ArrayCollection((array) $messages))
