 ...
 */
interface EnumerableInterface extends Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    /**
     ...
     * @template TMakeValue
     *
     * @param  Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|null  $elements
     ...
     *
     * @param  callable(TValue, TKey): (CollectionInterface<TFlatMapKey, TFlatMapValue>|array<TFlatMapKey, TFlatMapValue>)  $callback
     ...
     * @return TValue
     *
     * @throws \Terablaze\Collection\ItemNotFoundException
     * @throws \Terablaze\Collection\MultipleItemsFoundException
     */
     ...
     *
     * @return \Terablaze\Collection\CollectionInterface<TKey, TValue>
     */
