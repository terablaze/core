...
use Terablaze\Support\Interfaces\CanBeEscapedWhenCastToString;
 ...
 *
 */
class LazyCollection implements CanBeEscapedWhenCastToString, EnumerableInterface
{
    /**
     ...
     * @template TMakeValue
     *
     * @param  Arrayable<TMakeKey, TMakeValue>|iterable<TMakeKey, TMakeValue>|(Closure(): \Generator<TMakeKey, TMakeValue, mixed, void>)|self<TMakeKey, TMakeValue>|array<TMakeKey, TMakeValue>|null  $elements
     ...
     *
     * @param  Arrayable<array-key, TValue>|iterable<array-key, TValue>  $elements
     * @return static
     */
     ...
     *
     * @param  Arrayable<TKey, TValue>|iterable<TKey, TValue>  $elements
     * @return static
     */
     ...
     * @return static
     */
    public function intersectAssoc($elements)
    {
     ...
     * @return static
     */
    public function intersectAssocUsing($elements, callable $callback)
    {
     ...
     *
     * @param  Arrayable<TKey, TMergeRecursiveValue>|iterable<TKey, TMergeRecursiveValue>  $elements
    ...
    {
        return new static(function () use ($elements) {
     ...
     *
     * @param  callable(TValue, TKey, ArrayCollection<TKey, TValue>): bool  $callback
     ...
     * @template TZipValue
     *
     * @param  Arrayable<array-key, TZipValue>|iterable<array-key, TZipValue>  ...$elements
    ...
    public function zip($elements)
    {
        ...
        return new static(function () use ($iterables) {
            $iterators = ArrayCollection::make($iterables)->map(function ($iterable) {
